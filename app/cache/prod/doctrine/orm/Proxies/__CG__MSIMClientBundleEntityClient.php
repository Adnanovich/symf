...
namespace Proxies\__CG__\MSIM\ClientBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Client extends \MSIM\ClientBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MSIM\\ClientBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'MSIM\\ClientBundle\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'MSIM\\ClientBundle\\Entity\\Client' . "\0" . 'adresse');
        }
